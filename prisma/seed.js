...
async function main() {
  ...
  const product3 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-003' },
    update: {
  ...
  const product4 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-004' },
    update: {
  ...
  const product5 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-005' },
    update: {
  ...
  const product6 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-006' },
    update: {
  ...
  const product7 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-007' },
    update: {
  ...
  const product8 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-008' },
    update: {
  ...
  const product9 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-009' },
    update: {
  ...
  const product10 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-010' },
    update: {
  ...
  const product11 = await prisma.product.upsert({
    where: { productCode: 'PRD-20231015-011' },
    update: {
